...
var fba = function(g) {
    if (g.host != undefined && g.api != undefined && g.host != '' && g.api != '') {
        var j = '<div class="fba_direktori"></div>' + '<div class="fba_read_file"><i class="fa fa-code"></i> <span id="rf"></span>';
						j+='<div class="btn-group pull-right"><button name="btn-save-fba" id="btn-save-fba" class="btn btn-success btn-xs"><i class="fa fa-floppy-o"></i>&nbsp;Save</button><button name="btn-del-fba" id="btn-del-fba" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i>&nbsp;Del</button><button name="btn-new-fba" id="btn-new-fba" class="btn btn-primary btn-xs"><i class="fa fa-file-code-o"></i>&nbsp;New File</button></div>';
						j+='</div>' + '<textarea id="fba_text" name="fba_text"></textarea></div></div>',
